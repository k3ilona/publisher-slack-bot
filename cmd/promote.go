...
var promoteCmd = &cobra.Command{
	...
	Long:  `This command allows the user to upgrade the application version to the next environment. On command, the bot will perform the necessary actions to switch to the new version	and confirm the successful completion of the operation.`,
